...
# Trajectory Overplot log-scale -------------------------------------------
    ...
    n_gg_over = ggplot(data = indices_strat_smooth,aes(x = year, y = median,colour = hex_name))+
      ...
      labs(title = sp)+
        theme(legend.position = "none")+
      scale_y_log10()
    pdf(paste0("Figures/log_scale_trajectories_gamma-t_cmd_.pdf"),
        width = 11,
        height = 8.5)
    print(n_gg_over)
    dev.off()
...
save(list = c("trend_maps_1980",
              ...
              "season_graphs"),
     file = paste0("Figures/All_gamma_t_stored_maps.RData"))
...
# Trend maps --------------------------------------------------------------
pdf(file = paste0("Figures/All_gamma_t_trend_maps.pdf"),
    width = 9, height = 6.5)
for(sp in sps){
...
# Season Graphs --------------------------------------------------------------
pdf(file = paste0("Figures/All_gamma_t_Season_graphs.pdf"),
    width = 9, height = 6.5)
for(sp in sps){
...
pdf(file = paste0("Figures/All_gamma_t_Simple_Season_graphs.pdf"),
    width = 9, height = 6.5)
for(sp in sps){
...
pdf(file = paste0("Figures/All_gamma_t_Continental_Trajectories.pdf"),
    width = 9, height = 6.5)
for(sp in sps){
...
pdf(file = paste0("Figures/All_gamma_t_Strata_Trajectories.pdf"),
    width = 9, height = 6.5)
for(sp in sps){
...
pdf(file = paste0("Figures/All_gamma_t_Composite_Trajectories.pdf"),
    width = 9, height = 6.5)
for(sp in sps){
...
pdf(file = paste0("Figures/All_gamma_t_Diagnostic_Continental_Trajectories.pdf"),
    width = 9, height = 6.5)
for(sp in sps){
...
pdf(file = paste0("Figures/All_gamma_t_Diagnostic_Strata_Trajectories.pdf"),
    width = 9, height = 6.5)
for(sp in sps){
...
pdf(file = paste0("Figures/All_gamma_t_alphas_by_yr.pdf"),
    width = 9, height = 6.5)
for(sp in sps){
...
pdf(file = paste0("Figures/All_gamma_t_long_short_term_trends.pdf"),
    height = 9,
    width = 6.5)
print(lt_tplot)
dev.off()
...
pdf(file = paste0("Figures/First_gamma_t_last_15Year_trends.pdf"),
    height = 9,
    width = 6.5)
print(FL15_tplot)
dev.off()
...
pdf(file = paste0("Figures/All_gamma_t_early_recent_3generation_trends.pdf"),
    height = 9,
    width = 6.5)
print(el_tplot)
dev.off()
...
pdf(file = paste0("Figures/All_gamma_t_long_term_3Gen_trends.pdf"),
    height = 9,
    width = 6.5)
print(lt3_tplot)
dev.off()
...
pdf(file = paste0("Figures/All_gamma_t_beta_plots.pdf"),
    width = 9, height = 6.5)
for(sp in sps){
  if(!is.null(sp_ind_plots_strat_diagnostic[[sp]])){
...
pdf(file = paste0("Figures/All_gamma_t_trajectory_plots.pdf"),
    width = 9, height = 6.5)
for(sp in sps){
  if(!is.null(sp_ind_plots_strat_diagnostic[[sp]])){
...
pdf(file = paste0("Figures/All_gamma_t_Differences_in_trends_long_term_3Gen_trends.pdf"),
    height = 9,
    width = 6.5)
print(dif_tplot)
dev.off()
...
pdf(file = paste0("Figures/All_gamma_t_Differences_in_trends_all_previous_3Gen_trends.pdf"),
    height = 9,
    width = 6.5)
print(dif_tplot2)
dev.off()
...
pdf(file = paste0("Figures/All_gamma_t_Differences_in_trends_early_Vs_late_3Gen_trends.pdf"),
    height = 9,
    width = 6.5)
print(dif_tplot3)
dev.off()
