...
# fake - evenly distributed and oversimplified year-effects ----------------------------------
      ...
      # induce bias in the estimated trends
...
sp = paste("Simulated",sp1,sep = "_")    
   ...
   pdim = ceiling(sqrt(stan_data$nstrata))
...
#    
#    stan_data$nsites_strat <- as.integer(stan_data$nsites_strat)
#    
#    nyears = max(dts$yr)
...
#    
#    nKnots_season = 10
#    basis_season <- gam_basis(orig.preds = stan_data$date,
#                              nknots = nKnots_season,
#                              npredpoints = max(stan_data$date),
#                              sm_name = "season")
#    
...
#    basis_year <- gam_basis(orig.preds = stan_data$year_raw,
#                            nknots = nKnots_year,
#                            npredpoints = max(stan_data$year_raw),
#                            sm_name = "year")
#    
#    
#    
#    stan_data$season_basispred = basis_season$season_basispred
#    stan_data$nknots_season = basis_season$nknots_season
#    
#    stan_data$year_basispred = basis_year$year_basispred
#    stan_data$nknots_year = basis_year$nknots_year
#    
#    
#    
#    
