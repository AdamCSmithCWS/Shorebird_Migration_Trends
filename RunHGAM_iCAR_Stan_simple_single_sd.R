...
w_cosewic = sps[c(2:4,7,10,12:20,22,11,25)]
 ...
 for(sp in w_cosewic[13:15]){
   ...
   mod.file <- gsub(mod.file,pattern = ".stan",replacement = "_single_sd.stan")
## compile model
...
save(list = c("slope_icar_stanfit",
              ...
              "mod.file",
              "parms"),
     file = paste0("output/",sp,"_GAMYE_strat_simple_single_sd",grid_spacing/1000,".RData"))
...
load(paste0("output/",sp,"_GAMYE_strat_simple_single_sd",grid_spacing/1000,".RData"))
...
pdf(file = paste0("Figures/",sp,"simple_Season_single_sd.pdf"),
    width = 8.5,
    height = 8.5)
print(pp)
dev.off()
...
pdf(paste0("figures/",sp,FYYYY,"_GAMYE_survey_wide_trajectory_simple_single_sd",grid_spacing/1000,".pdf"))
print(N_gg)
dev.off()
...
pdf(file = paste0("figures/", sp,FYYYY,"_GAMYE_Strata_trajectories_simple_single_sd",grid_spacing/1000,".pdf"),
    width = 8.5,
    height = 11)
print(N_gg)
ncl = 3
...
pdf(paste0("Figures/Trend_Heat_maps__single_sd",sp,".pdf"),
    width = 11,
    height = 8.5)
